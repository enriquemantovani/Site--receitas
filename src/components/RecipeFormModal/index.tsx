                    ...
                    <div className="grid grid-cols-2 gap-2">
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex flex-col gap-1">                            
                                ...
                                <button type="button" className="bg-white border border-zinc-300 rounded-md hover:bg-gray-100 transition-colors px-4 py-2 
                                    font medium">Remover</button>
                                </div>
                                <button type="button" className="bg-white border border-zinc-300 rounded-md hover:bg-gray-100 transition-colors px-4 py-2 
                            font medium w-fit">Adicionar ingrediente</button>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col gap-1">
                            <div className="flex flex-col gap-1">                            
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <button type="button" className="bg-white border border-zinc-300 rounded-md hover:bg-gray-100 transition-colors px-4 py-2 
                                    font medium h-fit">Remover</button>
                                </div>

                                <button type="button" className="bg-white border border-zinc-300 rounded-md hover:bg-gray-100 transition-colors px-4 py-2 
                            font medium w-fit">Adicionar instrução</button>
                            </div>
                        </div>
